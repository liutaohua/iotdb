...
public class RemoveTagsOptimizer implements ILogicalOptimizer {
    ...
    public Operator transform(Operator operator, int fetchSize) throws QueryProcessException {
        ...
        try {
            ...
            queryOp.getSelectComponent().setResultColumns(
    ...
    private FromComponent getFromComponent(List<ResultColumn> resultColumns) throws IllegalPathException {
    ...
    private List<ResultColumn> getTagsResultColumn(TagsGenerator tagsGenerator) throws IOException, IllegalPathException {
    ...
    private List<ResultColumn> removeStar(List<ResultColumn> originPaths, List<ResultColumn> resultColumns) {
        if (originPaths == null || originPaths.isEmpty() || resultColumns == null || resultColumns.isEmpty()) {
            return originPaths;
        }
