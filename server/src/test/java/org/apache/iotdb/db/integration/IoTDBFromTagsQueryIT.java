...
public class IoTDBFromTagsQueryIT {
  ...
  public void TestTagsAndQuery() throws ClassNotFoundException {
    ...
    try (Connection connection =
      ...
      boolean hasResultSet =
          statement.execute(
              "select * from Tags(tag1='1' and tag2='2' and tag3='3' and tag6='6') where time>10");
  ...
  public void TestOrTagsQuery() throws ClassNotFoundException {
    ...
    try (Connection connection =
      ...
      boolean hasResultSet =
          statement.execute(
              "select * from Tags(tag1='1' or tag2='2' or tag3='3' or tag6='6') where time > 10");
      Assert.assertTrue(hasResultSet);
  ...
  public void TestMixTagsQuery() throws ClassNotFoundException {
    ...
    try (Connection connection =
      ...
      boolean hasResultSet =
          statement.execute(
              "select * from Tags(tag1='1' and tag2='2' and tag6='6' or tag5='5') where time > 10");
      Assert.assertTrue(hasResultSet);
      ...
      try (ResultSet resultSet = statement.getResultSet()) {
        ...
        List<Integer> actualIndexToExpectedIndexList =
            checkHeader(
                resultSetMetaData,
                "Time,root.ln.wf01.wt05.status," + "root.ln.wf01.wt06.status,",
                new int[] {
  ...
  public void TestMix2TagsQuery() throws ClassNotFoundException {
    ...
    try (Connection connection =
      ...
      boolean hasResultSet =
          statement.execute(
              "select * from Tags(tag5='5' or (tag3='3' and (tag2='2' or tag1='1')) ) where time > 10 ");
      Assert.assertTrue(hasResultSet);
    ...
    try (Connection connection =
      ...
      try (ResultSet resultSet = statement.getResultSet()) {
        ...
        List<Integer> actualIndexToExpectedIndexList =
            checkHeader(
                resultSetMetaData,
                "Time," + "root.ln.wf01.wt04.status," + "root.ln.wf01.wt05.status,",
                new int[] {
                  Types.TIMESTAMP, Types.INTEGER, Types.INTEGER,
                });
  ...
  public void TestExpTagsQuery() throws ClassNotFoundException {
    ...
    try (Connection connection =
      ...
      boolean hasResultSet =
          statement.execute(
              "select plus + plus2 from Tags(tag7='7'  or tag8='8' ) where time > 10 ");
      Assert.assertTrue(hasResultSet);
      ...
      try (ResultSet resultSet = statement.getResultSet()) {
        ...
        List<Integer> actualIndexToExpectedIndexList =
            checkHeader(
                resultSetMetaData,
                "Time,root.ln.wf01.wt07.plus + root.ln.wf01.wt08.plus2,",
                new int[] {
                  Types.TIMESTAMP, Types.DOUBLE,
                });
