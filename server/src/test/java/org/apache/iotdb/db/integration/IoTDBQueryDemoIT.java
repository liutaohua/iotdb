...
public class IoTDBQueryDemoIT {
  ...
  private static String[] sqls =
      new String[] {
        ...
        "ALTER timeseries root.ln.wf01.wt01.temperature ADD TAGS tag33=c",
        ...
        "ALTER timeseries root.ln.wf02.wt02.status ADD TAGS tag1=b",
        ...
        "ALTER timeseries root.sgcc.wf03.wt01.status ADD TAGS tag33=c",
  ...
  @Test
  public void tagsQueryTest() throws ClassNotFoundException {
    ...
    try (Connection connection =
      ...
      boolean hasResultSet = statement.execute("select * from Tags(tag1='b')");
      Assert.assertTrue(hasResultSet);
      try (ResultSet resultSet = statement.getResultSet()) {
        ResultSetMetaData resultSetMetaData = resultSet.getMetaData();
        List<Integer> actualIndexToExpectedIndexList =
            checkHeader(
                resultSetMetaData,
                "Time,root.ln.wf02.wt02.status,",
                new int[] {
                  Types.TIMESTAMP, Types.BOOLEAN,
                });
      ...
      // test 2: tags and query
      hasResultSet = statement.execute("select * from Tags(tag1='b' and tag33='c')");
      ...
      retArray =
          new String[] {
            "1509465600000,true,25.96,true",
            "1509465660000,true,24.36,true",
            "1509465720000,false,20.09,false",
            "1509465780000,false,20.18,false",
            "1509465840000,false,21.13,false",
            "1509465900000,false,22.72,false",
            "1509465960000,false,20.71,false",
            "1509466020000,false,21.45,false",
            "1509466080000,false,22.58,false",
            "1509466140000,false,20.98,false",
          };
      hasResultSet = statement.execute("select * from Tags(tag1='b' or tag33='c')");
      Assert.assertTrue(hasResultSet);
      try (ResultSet resultSet = statement.getResultSet()) {
        ResultSetMetaData resultSetMetaData = resultSet.getMetaData();
        List<Integer> actualIndexToExpectedIndexList =
            checkHeader(
                ...
                new int[] {
                  Types.TIMESTAMP, Types.BOOLEAN, Types.FLOAT, Types.BOOLEAN,
                });
